...
- **Volume jumps on track change:** verify the Atlas log says `Extension connected: 1.0.8`; disable old unpacked Lyricsflow copies in Edge and reload the YouTube Music tab. The Galaxy slider now adjusts Windows master output, which is independent of YouTube Music's own volume.
